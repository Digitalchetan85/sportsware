...
<body>
    ...
    <table style="width:600px;text-align:right">
        ...
        <tbody>
            ...
            <tr>
                <td><img src="{{ asset('assets/images/products') }}/{{ $item->product->image }}" alt="" width="100">
                </td>
            ...
            <tr>
                ...
                <td style="font-size:15px;font-weight:bold;border-top:1px #ccc;">Subtotal : ₹{{ $order->subtotal }}</td>
            </tr>
            <tr>
                <td colspan="3"></td>
