            ...
            <div class="panel panel-default ">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal " wire:submit.prevent="saveSettings">
                        ...
                        <div class="form-group">
                            <label  class="col-md-4 text-right">Phone2</label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label  class="col-md-4 text-right">Map</label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label  class="col-md-4 text-right" >Twitter</label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label  class="col-md-4 text-right">Pinterest</label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label  class="col-md-4 text-right">Instagram</label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label  class="col-md-4 text-right">Youtube</label>
                            <div class="col-md-4">
