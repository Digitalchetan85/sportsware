...
<body class="home-page home-01 ">
									...
									@auth
										...
										<li class="menu-item menu-item-has-children parent" >
											...
											<ul class="submenu curency" >
												...
												<li class="menu-item" >
													<a title="Home Categories" href="{{ route('admin.home-categories') }}">Home Categories</a>
												</li>
												<li class="menu-item" >
	...
	<script src="{{ asset('assets/js/jquery-1.12.4.minb8ff.js?ver=1.12.4') }}"></script>
        ...
        <script src="https://cdn.tiny.cloud/1/z6veh4f2nklrry6b10gsnphupdx3l5gohaaiq76iho0hwhtw/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
	@livewireScripts
	@stack('scripts')
</body>
</html>